...
export const createSpecialty = async (req: Request, res: Response) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Error al crear la especialidad", details: error });
  }
};
...
export const getSpecialties = async (_req: Request, res: Response) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Error al obtener especialidades", details: error });
  }
};
...
export const getSpecialtyById = async (req: Request, res: Response) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Error al buscar la especialidad", details: error });
  }
};
...
export const deleteSpecialty = async (req: Request, res: Response) => {
  ...
  try {
    ...
    res
      .status(400)
      .json({ error: "Error al eliminar la especialidad", details: error });
  }
};
...
export const checkSpecialtyByName = async (req: Request, res: Response) => {
  ...
  if (!name || typeof name !== "string") {
    res
      .status(400)
      .json({ error: "El parámetro 'name' es requerido como string." });
    return;
  }
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Error al verificar la especialidad", details: error });
  }
};
