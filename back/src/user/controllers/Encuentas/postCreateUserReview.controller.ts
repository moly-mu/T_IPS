...
export const createUserReview = async (
  ...
  try {
    ...
    if (appointment.Paciente_User_idUser !== userId ||
    ...
    if (existingReview) {
      return res.status(409).json({ 
        error: "Ya has reseñado a este especialista. No puedes crear múltiples reseñas." 
      });
    }
    ...
    // Formatear respuesta similar a tu estilo
