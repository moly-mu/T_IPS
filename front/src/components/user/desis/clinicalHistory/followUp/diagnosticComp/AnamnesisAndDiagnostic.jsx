    ...
    return(
        ...
        <div className='max-w-2xl mx-auto p-6 bg-gray-50 min-h-screen'>
            <div className='space-y-4'>
                <div>
                <label className='block text-sm font-medium mb-2'>Motivo de Consulta y Enfermedad Actual</label>
                <textarea className='w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#2F079D]'
                rows='4'
                value={formData.consultReason}
                onChange={(e) => handleInputChange('consultReason', e.target.value)}
                placeholder='Describa a detalle el motivo de consulta y la enfermedad actual del paciente...'></textarea>
                </div>
            </div>
        </div>
...
export default AnamnesisAndDiagnostic;
